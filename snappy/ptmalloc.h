...
/*
  ...
  $Id: ptmalloc.h,v 1.1.1.1 1999/11/06 12:28:55 wg Exp $
...
/*Both these methods are currently for non persistent memory*/
extern __malloc_ptr_t pt_nvmalloc(size_t __size);
extern __malloc_ptr_t pt_free(size_t __size);
extern __malloc_ptr_t pt_nvrealloc __MALLOC_P ((__malloc_ptr_t __ptr, size_t __size));

extern __malloc_ptr_t pt_nvcalloc __MALLOC_P ((size_t __nmemb, size_t __size));
...
extern __malloc_ptr_t realloc __MALLOC_P ((__malloc_ptr_t __ptr, size_t __size));
 ...
 Free a block allextern __malloc_ptr_t ocated by `malloc', `realloc' or `calloc'.
